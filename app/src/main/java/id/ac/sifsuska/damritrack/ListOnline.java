...
import id.ac.sifsuska.damritrack.Model.User;
...
public class ListOnline extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    FirebaseRecyclerAdapter<id.ac.sifsuska.damritrack.Model.User,ListOnlineViewHolder> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("DAMRI Tracking");
    ...
    private void setupSystem() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue(Boolean.class))
                {
                    ...
                    counterRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                            .setValue(new id.ac.sifsuska.damritrack.Model.User(FirebaseAuth.getInstance().getCurrentUser().getEmail(),"Online"));
                    adapter.notifyDataSetChanged();
                }
            }
        ...
        counterRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    id.ac.sifsuska.damritrack.Model.User user = postSnapshot.getValue(id.ac.sifsuska.damritrack.Model.User.class);
